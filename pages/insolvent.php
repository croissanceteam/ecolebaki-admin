                    ...
                    <div class="col-lg-12">
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading" style="height:3.3em">
                          Critères d'éditon
                          <button type="button" class="btn btn-success" ng-click="getInsolvents()" style="float:right;margin-top:-0.3em">
                      ...
                      <div class="panel-body">
                        <table style="width:100%">
                          ...
                          <tr>
                            ...
                            <th class="label-value"> : {{insolventsCounter}} sur {{pupilsCounter}} élèves</th>
                          </tr>
                        </table>
                        <hr>
                        ...
                        <table class="table table-striped">
                          ...
                          <tbody>
                            <tr ng-repeat="pupil in insolventList">
