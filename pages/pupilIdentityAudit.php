...
<html>
    ...
    <head>
        ...
        <title>Audit des identités</title>
                ...
                <div class="row ng-hide" ng-show="showCriteria">
                    ...
                    <div class="col-lg-12">
                        <label class="page-header" style="width: 100%;font-size: 16px;">
                            Audit des modifications d'identité des élèves
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading" style="height:3.3em">
                          Critères d'édition
                          <button type="button" class="btn btn-success" ng-click="getReport()" style="float:right;margin-top:-0.3em">
                        ...
                        <div class="panel-body">
                          <form>
                              ...
                              <div class="form-group col-sm-3" style="text-align:center;">
                                  ...
                                  <select class="form-control" id="promotion" ng-model="cbo_promotion" ng-change="criteriaChanged()" class="chzn-select" style="width:100%">
                              ...
                              <div class="form-group col-sm-3" style="text-align:center;">
                                ...
                                <select id="trim" class="form-control" ng-model="cbo_trim" ng-change="criteriaChanged()" name="month">
                              ...
                              <div class="form-group col-sm-3" style="text-align:center;">
                                <label for="report">ETAT</label>
                                <select id="report" class="form-control" ng-model="cbo_report" ng-change="criteriaChanged()" name="report">
